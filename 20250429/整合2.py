...
def plot_interactive_map_with_person_and_bus(geojson_file: str, output_html: str, selected_stop_name: str, person_icon_path: str, bus_icon_path: str):
    ...
    for feature in geojson_data["features"]:
        ...
        elif stop_time.strip() == "進站中":  # 確保 stop_time 格式正確
    ...
    m.save(output_html)
    print(f"互動地圖（含所有進站中的公車）已儲存至 {output_html}")
...
if __name__ == "__main__":
    ...
    if geojson_file:
        ...
        output_html = os.path.join(output_dir, f"bus_stops_{route_id}_{direction}_with_person_and_buses.html")
