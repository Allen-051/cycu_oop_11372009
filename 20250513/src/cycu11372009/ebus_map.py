...
import csv
import os
from cycu11372004.ebus import get_bus_info_go
...
if __name__ == "__main__":
    ...
    bus = BusInfo("0100000A00")
    print(f"Bus ID: {bus.bus_id}")
    print(f"Route Info Go: {bus.get_bus_info_go()}")
    print(f"Route Info Come: {bus.get_bus_info_come()}")

    # get stop name of second stop of route_info_go
    route_info_go = bus.get_bus_info_go()
